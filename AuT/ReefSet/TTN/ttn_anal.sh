...
python -m AuT.ReefSet.TTN.ttn_anal --dataset 'ReefSet' \
    --adpt_set_path $BASE_PATH'/data/Ada-ReefSet-C'\
    --eval_set_path $BASE_PATH'/data/ReefSet-C'\
    --batch_size 32 --output_file_name 'AuT_RS-C_TTN_analysis-02.csv' \
    --adpt_batch_size 70 --lr_momentum 0.1 \
...
python -m AuT.ReefSet.TTN.ttn_anal --dataset 'ReefSet' \
    --adpt_set_path $BASE_PATH'/data/Ada-ReefSet-C'\
    --eval_set_path $BASE_PATH'/data/ReefSet-C'\
    --batch_size 32 --output_file_name 'AuT_RS-C_TTN_analysis-03.csv' \
    --adpt_batch_size 70 --lr_momentum 0.1 \
...
python -m AuT.ReefSet.TTN.ttn_anal --dataset 'ReefSet' \
    --adpt_set_path $BASE_PATH'/data/Ada-ReefSet-C'\
    --eval_set_path $BASE_PATH'/data/ReefSet-C'\
    --batch_size 32 --output_file_name 'AuT_RS-C_TTN_analysis-04.csv' \
    --adpt_batch_size 70 --lr_momentum 0.1 \
...
python -m AuT.ReefSet.TTN.ttn_anal --dataset 'ReefSet' \
    --adpt_set_path $BASE_PATH'/data/Ada-ReefSet-C'\
    --eval_set_path $BASE_PATH'/data/ReefSet-C'\
    --batch_size 32 --output_file_name 'AuT_RS-C_TTN_analysis-05.csv' \
    --adpt_batch_size 70 --lr_momentum 0.1 \
