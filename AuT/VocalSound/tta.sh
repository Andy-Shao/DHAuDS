...
python -m AuT.VocalSound.ttda --dataset 'VocalSound' --dataset_root_path $BASE_PATH'/data/Ada-VocalSound-C' \
    ...
    --nucnm_rate 1.0 --ent_rate 0.0 --gent_rate 0.25 --gent_q 1.1 --mse_rate 0.1 \
    --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
    --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt'
...
#     --nucnm_rate 1.0 --ent_rate 1.0 --gent_rate 0.0 --gent_q 1.1 --mse_rate 0.01 \
#     --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#     --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
...
#     --nucnm_rate 1.0 --ent_rate 0.0 --gent_rate 0.5 --gent_q 1.1 --mse_rate 1.0 \
#     --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#     --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
...
#     --nucnm_rate 1.0 --ent_rate 0.1 --gent_rate 0.1 --gent_q 1.1 --mse_rate 0.5 \
#     --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#     --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
...
#     --nucnm_rate 1.0 --ent_rate 0.1 --gent_rate 1.0 --gent_q 1.1 --mse_rate 0.6 \
#     --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#     --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
...
#    --nucnm_rate 1.0 --ent_rate 0.5 --gent_rate 1.0 --gent_q 1.1 --mse_rate 1.0 \
#    --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#    --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
...
#    --nucnm_rate 1.0 --ent_rate 0.0 --gent_rate 1.0 --gent_q 1.1 --mse_rate 0.5 \
#    --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#    --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
...
#    --nucnm_rate 1.0 --ent_rate 0.5 --gent_rate 0.0 --gent_q 1.1 --mse_rate 0.1 \
#    --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#    --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
...
#    --nucnm_rate 1.0 --ent_rate 0.1 --gent_rate 1.0 --gent_q 1.1 --mse_rate 0.5 \
#    --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#    --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
...
#    --nucnm_rate 1.0 --ent_rate 0.0 --gent_rate 0.5 --gent_q 1.1 --mse_rate 0.5 \
#    --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#    --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
...
#     --nucnm_rate 1.0 --ent_rate 1.0 --gent_rate 0.1 --gent_q 1.1 --mse_rate 0.5 \
#     --aut_wght_pth './result/VocalSound/AMAuT/train/aut-VS.pt' \
#     --clsf_wght_pth './result/VocalSound/AMAuT/train/clsf-VS.pt' --wandb
