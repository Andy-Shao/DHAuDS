...
from AuT.UrbanSound8K.utils import Us8AuT
...
def analyzing(args:argparse.Namespace, corruption_types:list[str], corruption_levels:list[str]) -> None:
    ...
    for idx, cmeta in enumerate(corruption_metas):
        ...
        orig_f1 = inference(args=args, aut=aut, clsf=clsf, data_loader=eval_loader)

        print('TTN adapting...')
        tp_model = Us8AuT(aut=aut, clsf=clsf)
        ...
        adpt_f1 = inference(args=args, aut=aut, clsf=clsf, data_loader=eval_loader)
