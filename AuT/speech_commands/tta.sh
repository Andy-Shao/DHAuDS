...
python -m AuT.speech_commands.tta --dataset 'SpeechCommandsV2' --dataset_root_path $BASE_PATH'/data' \
    --max_epoch 20 --lr_cardinality 50 --batch_size 32 --lr '1e-4' --num_workers 16 --auT_lr_decay 0.1 \
    ...
    --corruption_level 3.0 --corruption_type 'doing_the_dishes' --fbnm_rate 1.0 \
