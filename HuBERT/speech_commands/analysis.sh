...
#     --batch_size 32 --origin_auT_weight './result/SpeechCommandsV2/HuBERT/hubert-base.pt' \
#     --origin_cls_weight './result/SpeechCommandsV2/HuBERT/clsModel-base.pt'

python -m HuBERT.speech_commands.analysis --dataset 'SpeechCommandsV2' --dataset_root_path $BASE_PATH'/data' \
    --background_path $BASE_PATH'/data/CochlScene' --background_type 'CochlScene' \
    --corruption_level 3.0 --batch_size 32 --origin_auT_weight './result/SpeechCommandsV2/HuBERT/hubert-base.pt' \
    --origin_cls_weight './result/SpeechCommandsV2/HuBERT/clsModel-base.pt'