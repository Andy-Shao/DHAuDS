...
if __name__ == '__main__':
    ...
    b_roc_auc = inference(args=args, aut=aut, clsf=clsf, data_loader=test_loader)
    ...
    a_roc_auc = inference(args=args, aut=aut, clsf=clsf, data_loader=test_loader)
    print(f'After adaptation accuray is: {a_roc_auc:.4f}, sample size is: {len(noise_set)}')
