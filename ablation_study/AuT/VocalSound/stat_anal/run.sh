...
# Experiment 01
# python -m ablation_study.AuT.VocalSound.aut_fix_analysis --dataset 'VocalSound' \
...
#     --max_epoch 20 --lr 1e-4 --nucnm_rate 1.0 --ent_rate 0.0 --gent_rate 0.0 --gent_q 2.0 --mse_rate 0.1 \
#     --orig_wght_pth './result/VocalSound/AMAuT/train' --wandb

# python -m ablation_study.AuT.VocalSound.stat_anal.analysis --dataset 'VocalSound' \
...
python -m ablation_study.AuT.VocalSound.aut_fix_analysis --dataset 'VocalSound' \
    ...
    --background_path $BASE_PATH'/data/DEMAND_16k' --output_path $BASE_PATH'/tmp' --batch_size 70 \
    --max_epoch 20 --lr 1e-4 --nucnm_rate 1.0 --ent_rate 0.0 --gent_rate 0.0 --gent_q 2.0 --mse_rate 0.1 \
    --orig_wght_pth './result/VocalSound/AMAuT/train' --seed 111089
