...
from lib.component import Components, time_shift, AmplitudeToDB, FrequenceTokenTransformer
from lib.component import MelSpectrogramPadding, AudioPadding, AudioClip
    ...
    test_set = MultiTFDataset(
        ...
        tfs=[
            Components(transforms=[
                ...
                AudioClip(max_length=args.audio_length, is_random=False),
                MelSpectrogram(
