...
from lib.component import Components, ReduceChannel, time_shift, AudioPadding, AudioClip
...
from ablation_study.HuBERT.VocalSound.hub_fix_analysis import build_noise_set
from PANNs.lib.utils import load_weight, store_weight, pan_freeze, build_model, is_stored
...
if __name__ == '__main__':
    ...
    for epoch in range(args.max_epoch+1):
        ...
        max_accu, store_flag = is_stored(max_val=max_accu, curr_val=eval_accu, max_mode=args.max_mode)
        if store_flag:
            store_weight(
