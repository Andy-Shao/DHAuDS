...
def build_noise_set(args:argparse.Namespace) -> Dataset:
    ...
    mlt_store_to(
        dataset=vs, root_path=set_path, index_file_name=index_file_name,
...
if __name__ == '__main__':
    ...
    test_set = MultiTFDataset(dataset=noise_set, tfs=[ReduceChannel()])
    ...
    load_weight(args=args, hubert=hubert, clsf=clsf)
