...
if __name__ == '__main__':
    ...
    b_accu = inference(args=args, hubert=hubert, clsModel=clsf, data_loader=test_loader)
    ...
    a_accu = inference(args=args, hubert=hubert, clsModel=clsf, data_loader=test_loader)
