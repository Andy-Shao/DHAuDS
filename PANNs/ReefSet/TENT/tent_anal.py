...
from lib.component import Components, AudioClip, AudioPadding, ReduceChannel, OneHot2Index
from lib.tentAdapt import verify_model, get_params, TentAdapt
...
def analyzing(args:argparse.Namespace, corruption_types:list[str], corruption_levels:list[str]) -> None:
    ...
    for idx, cmeta in enumerate(corruption_metas):
        ...
        adpt_roc_auc = inference(args=args, pan=pan, clsf=clsf, data_loader=eval_loader)
