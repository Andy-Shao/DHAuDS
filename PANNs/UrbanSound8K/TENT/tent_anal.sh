...
python -m PANNs.UrbanSound8K.TENT.tent_anal --dataset 'UrbanSound8K' \
    ...
    --eval_set_path $BASE_PATH'/data/UrbanSound8K-C' \
    --batch_size 32 --adpt_batch_size 70 --lr 1e-3 \
    --output_file_name 'PAN_US8-C_TENT_analysis-02.csv' \
...
python -m PANNs.UrbanSound8K.TENT.tent_anal --dataset 'UrbanSound8K' \
    ...
    --eval_set_path $BASE_PATH'/data/UrbanSound8K-C' \
    --batch_size 32 --adpt_batch_size 70 --lr 1e-3 \
    --output_file_name 'PAN_US8-C_TENT_analysis-03.csv' \
...
python -m PANNs.UrbanSound8K.TENT.tent_anal --dataset 'UrbanSound8K' \
    ...
    --eval_set_path $BASE_PATH'/data/UrbanSound8K-C' \
    --batch_size 32 --adpt_batch_size 70 --lr 1e-3 \
    --output_file_name 'PAN_US8-C_TENT_analysis-04.csv' \
...
python -m PANNs.UrbanSound8K.TENT.tent_anal --dataset 'UrbanSound8K' \
    ...
    --eval_set_path $BASE_PATH'/data/UrbanSound8K-C' \
    --batch_size 32 --adpt_batch_size 70 --lr 1e-3 \
    --output_file_name 'PAN_US8-C_TENT_analysis-05.csv' \
