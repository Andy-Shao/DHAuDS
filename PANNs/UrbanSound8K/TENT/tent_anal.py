...
from PANNs.UrbanSound8K.utils import inference
...
def analyzing(args:argparse.Namespace, corruption_types:list[str], corruption_levels:list[str]) -> None:
    ...
    for idx, cmeta in enumerate(corruption_metas):
        ...
        orig_f1 = inference(args=args, pan=pan, clsf=clsf, data_loader=eval_loader)
        ...
        adpt_f1 = inference(args=args, pan=pan, clsf=clsf, data_loader=eval_loader)
