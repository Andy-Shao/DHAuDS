...
python -m PANNs.VocalSound.TTN.ttn_anal --dataset 'VocalSound' \
    ...
    --eval_set_path $BASE_PATH'/data/VocalSound-C' \
    --batch_size 32 --adpt_batch_size 70 --lr_momentum 0.1 \
    --output_file_name 'PAN_VS-C_TTN_analysis-02.csv' \
...
python -m PANNs.VocalSound.TTN.ttn_anal --dataset 'VocalSound' \
    ...
    --eval_set_path $BASE_PATH'/data/VocalSound-C' \
    --batch_size 32 --adpt_batch_size 70 --lr_momentum 0.1 \
    --output_file_name 'PAN_VS-C_TTN_analysis-03.csv' \
...
python -m PANNs.VocalSound.TTN.ttn_anal --dataset 'VocalSound' \
    ...
    --eval_set_path $BASE_PATH'/data/VocalSound-C' \
    --batch_size 32 --adpt_batch_size 70 --lr_momentum 0.1 \
    --output_file_name 'PAN_VS-C_TTN_analysis-04.csv' \
...
python -m PANNs.VocalSound.TTN.ttn_anal --dataset 'VocalSound' \
    ...
    --eval_set_path $BASE_PATH'/data/VocalSound-C' \
    --batch_size 32 --adpt_batch_size 70 --lr_momentum 0.1 \
    --output_file_name 'PAN_VS-C_TTN_analysis-05.csv' \
