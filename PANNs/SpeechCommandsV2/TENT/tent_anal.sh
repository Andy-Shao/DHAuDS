...
python -m PANNs.SpeechCommandsV2.TENT.tent_anal --dataset 'SpeechCommandsV2' \
    ...
    --eval_set_path $BASE_PATH'/data/SpeechCommandsV2-C' \
    --batch_size 32 --adpt_batch_size 70 --lr 1e-5 \
    --output_file_name 'PAN_SC2-C_TENT_analysis-02.csv' \
...
python -m PANNs.SpeechCommandsV2.TENT.tent_anal --dataset 'SpeechCommandsV2' \
    ...
    --eval_set_path $BASE_PATH'/data/SpeechCommandsV2-C' \
    --batch_size 32 --adpt_batch_size 70 --lr 1e-5 \
    --output_file_name 'PAN_SC2-C_TENT_analysis-03.csv' \
...
python -m PANNs.SpeechCommandsV2.TENT.tent_anal --dataset 'SpeechCommandsV2' \
    ...
    --eval_set_path $BASE_PATH'/data/SpeechCommandsV2-C' \
    --batch_size 32 --adpt_batch_size 70 --lr 1e-5 \
    --output_file_name 'PAN_SC2-C_TENT_analysis-04.csv' \
...
python -m PANNs.SpeechCommandsV2.TENT.tent_anal --dataset 'SpeechCommandsV2' \
    ...
    --eval_set_path $BASE_PATH'/data/SpeechCommandsV2-C' \
    --batch_size 32 --adpt_batch_size 70 --lr 1e-5 \
    --output_file_name 'PAN_SC2-C_TENT_analysis-05.csv' \
