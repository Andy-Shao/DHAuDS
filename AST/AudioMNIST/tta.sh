...
python -m AST.AudioMNIST.ttda --dataset 'AudioMNIST' --dataset_root_path $BASE_PATH'/data/AudioMNIST/data' \
    ...
    --ast_wght_pth './result/AudioMNIST/AST/Train/AST-AM-ast.pt' \
    --clsf_wght_pth './result/AudioMNIST/AST/Train/AST-AM-clsf.pt' --wandb