...
python -m AST.CochlScene.ttda --dataset 'CochlScene' --dataset_root_path $BASE_PATH'/data/CochlScene' \
    ...
    --max_epoch 120 --lr_cardinality 50 --batch_size 30 --lr '1e-4' --ast_lr_decay 0.55 --num_workers 16 \
    --nucnm_rate 0.1 --lr_gamma 30 --lr_threshold 35 \
    --ent_rate 1.0 --gent_rate 1.0 --gent_q 1.1 --corruption_type 'WHNP' --corruption_level 'L2' \
